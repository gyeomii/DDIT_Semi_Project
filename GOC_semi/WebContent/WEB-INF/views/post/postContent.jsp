		...
		<div class="starter-template">
			<div class="free_borad_main_title">
				<div class="free_borad_main_title_border">
					<c:if test="${post.category eq 1 }">
						<h4>공지사항</h4>
					</c:if>
					<c:if test="${post.category eq 2 }">
						<h4>자유 게시판</h4>
					</c:if>
				</div>
			</div>
				...
				<div class="side_board_pannel">
					...
					<div class="side_board_pannel_list">
						<div class="row">
							...
							<div>
								<span class="side_board_pannel_post"> <a
									class="title_herf_path_cut" href="#">※공지사항입니다. 부디읽어주시길
										바랍니다. 다같이 행복해</a></span>
							</div>
						</div>
					</div>
				...
				<div class="side_board_pannel">
					...
					<div class="side_board_pannel_list">
						<div class="row">
							<div>
								<span class="side_board_pannel_post"> <a
									class="title_herf_path_cut" href="#">★점심추천 가게위치들 모음집</a></span>
							</div>
